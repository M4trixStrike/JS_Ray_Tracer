...
let cube1 = new RT.Cube(
    new RT.Point3D(8,8,13),
    15,
    material1
);
cube1.rotateZ(45);

let cube2 = new RT.Cube(
    new RT.Point3D(0,-5,18),
    5,
    material7
);
cube2.rotateZ(45);

let sphere1 = new RT.Sphere(new RT.Point3D(8, 6, -0.5), 6, material3)
let sphere2 = new RT.Sphere(new RT.Point3D(-9, 2, 14), 6, material2)


demoScene.addObject(cube1);
demoScene.addObject(cube2);
